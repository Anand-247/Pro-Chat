...
import { Search, Plus, LogOut, Loader2, X, Check, Settings } from "lucide-react";
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-slate-400 truncate">
                    {typingChats && typingChats[chat.id] ? (
                       <span className="text-primary italic animate-pulse group-hover:text-white transition-colors">Typing...</span>
                    ) : chat.latestMessage ? (
                      chat.latestMessage.senderId === user.id ? `You: ${chat.latestMessage.content}` : chat.latestMessage.content
                    ) : (
                      "No messages yet"
                    )}
                  </p>
